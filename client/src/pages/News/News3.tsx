...
const News3 = () => {
    return (
        <div className='article'>
            ...
            <img src='https://i1-suckhoe.vnecdn.net/2020/10/29/PUTjxpx7A2FUTlyGjozrjeOQ4fCyKL-1804-6334-1603945453.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=gJM4VE-gni-aoqsMS0-luQ'/>
            <div className='source'>
                <i>
                Phó giáo sư, Tiến sĩ, bác sĩ Nguyễn Huy Thắng
                </i>
            </div>
            <p>
            ...
            <p className='source'>
                <a href='https://dotquy.kcb.vn/hieu-dung-ve-dot-quy/loi-song-khoe-manh-day-lui-dot-quy/70-nguy-co-dot-quy-co-the-phong-ngua.html'>BỘ Y TẾ</a>
            </p>
        </div>
    )
}
